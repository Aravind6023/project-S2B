...
<ul>
  ...
  <li>
    <h3>Account editing:</h3> Both buyers and sellers have the capability to edit their account details. This feature enables users to update their personal information, such as contact details, shipping address, or profile picture, ensuring that their account information remains up-to-date.
  </li>
  <li>
    <h3>Messaging feature:</h3> A messaging feature is implemented to facilitate direct communication between buyers and sellers. Buyers can inquire about products, negotiate prices, or ask questions directly to the sellers through this messaging feature, streamlining the communication process between both parties.
  </li>
  <li>
