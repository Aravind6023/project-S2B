                    ...
                    <section className="col-12 p-0">
                        <nav class="navbar navbar-expand-lg bg-transparent">
                            <div className="container-fluid">
                                <Link className="navbar-brand col-1" to="/userhome/:id"><img className='rounded-circle logo col-12 col-lg-6' src={logo} alt="logo"></img></Link>
                                ...
                                <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                                    <ul className="navbar-nav mb-2 w-75 mb-lg-0 d-lg-flex align-items-lg-center justify-content-evenly">
                                        ...
                                        <li>
                                            <h6 className="text-white m-0 py-3 p-lg-0">Welcome {fname}</h6>
                                        </li>
                                    </ul>
                                </div>
                            </div>
